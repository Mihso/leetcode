...
//         int lengther = word.length();
//         int counter = 0;
//         while(lengther > 0){
//             for(int i = 0; i < word.length() - lengther +1 ; i++){
//                 String check = word.substring(i, i+ lengther);
//                 Map<Character, Integer> mapper= new HashMap<>();
//                 for(int j = 0; j < check.length(); j++){
//                     if(!mapper.containsKey(check.charAt(j))){
//                         mapper.put(check.charAt(j), 0);
//                     }
//                     mapper.put(check.charAt(j), mapper.get(check.charAt(j)) + 1);
//                 }
                
//                 int odder = 0;
//                 for(int c : mapper.values()){
//                     if(c % 2 != 0){
//                         odder++;
//                     }
//                 }
